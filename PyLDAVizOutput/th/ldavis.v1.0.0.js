...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        d3.select("#" + leftPanelID).append("text")
            ...
            .text("สัดส่วนการกระจายหัวของหัวข้อ");
        d3.select("#" + leftPanelID).append("text")
            .attr("x", cx2 + 10)
        ...
        svg.append("text")
            .text("แผนที่ระยะห่างระหว่างหัวข้อ (ทำโดยวิธีการปรับสเกลแบบหลายมิติ)")
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("ความถี่ประมาณการในหัวข้อที่เลือก");
        ...
        d3.select("#" + barFreqsID)
            ...
            .style("dominant-baseline", "middle")
            .text("1. saliency; see Chuang et. al (2012)");
        ...
        d3.select("#" + barFreqsID)
            ...
            .style("dominant-baseline", "middle")
            .text("2. relevance; see Sievert & Shirley (2014)");
   //
        d3.select("#" + barFreqsID)
            .append("a")
            .attr("target", "_blank")
            ...
            .style("dominant-baseline", "middle")
            .text("เมื่อ λ = 0 คือ " + '"คำเฉพาะที่พบในแต่ละหัวข้อ"');
        d3.select("#" + barFreqsID)
            .append("a")
            .attr("target", "_blank")
            .append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("หรือ λ = 1 คือ " + '"คำทั่วไปที่พบในแต่ละหัวข้อ"');
        d3.select("#" + barFreqsID)
            .append("a")
            .attr("target", "_blank")
            .append("text")
            .attr("x", 12)
            .attr("y", mdsheight + 10 + (14/2)*barguide.height + 5)
            .style("dominant-baseline", "middle")
            .text("ค่าตั้งต้น (default) λ = 0.6");
        //
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.innerHTML = "เลือกหมายเลขหัวข้อ: <span id='" + topicID + "-value'></span>";
            ...
            var xx = d3.select("#" + lambdaZeroID)
                    ...
                    .text("ปรับการจัดอันดับคำในหัวข้อ")
...
// markdown here by pywt.sm
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text(R + " คำแรกที่เกี่ยวข้องกับหัวข้อที่ " + topics + " (" +"คิดเป็น "+ Freq + "% ของคำทั้งหมด)");
        ...
        function term_off(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("สัดส่วนการกระจายตัวของหัอข้อ");
